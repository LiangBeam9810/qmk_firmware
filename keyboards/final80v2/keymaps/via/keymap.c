...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(RESET  , RGB_HUI, RGB_HUD,  RGB_SAI,  RGB_SAD,  RGB_VAD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MUTE,            //
                   ...
                   KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,      KC_4,    KC_5,     KC_6, KC_TRNS, RGB_TOG,                                 //
                   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,       KC_1,    KC_2,     KC_3, KC_TRNS, RGB_MOD, RGB_VAI,                            //
                   KC_TRNS, TG(1), KC_TRNS, KC_TRNS, KC_0, KC_TRNS, KC_TRNS, RGB_VAD, RGB_RMOD),
};
